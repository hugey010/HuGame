...
// GAME DEFINITIONS
#define ROUND_INTERVAL 40.0 // seconds, 2 minutes
#define GROUND_END_Y SCREEN_HEIGHT / 3

#define ENEMY_SPEED 300

#define SOLDIER_MAX_FIRING_INTERVAL 1.5 //.5
#define SOLDIER_MIN_FIRING_INTERVAL 0.5 //.1
#define CANNON_MAX_FIRING_INTERVAL 2.0
#define CANNON_MIN_FIRING_INTERVAL 1.0

// cost constants
#define COST_HEALTH 100
#define COST_CANNON 200
#define COST_SOLDIER 50
