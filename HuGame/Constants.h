...
// GAME DEFINITIONS
#define ROUND_INTERVAL 55.0 // seconds, 2 minutes
#define GROUND_END_Y SCREEN_HEIGHT / 3

#define ENEMY_SPEED 300

#define SOLDIER_MAX_FIRING_INTERVAL 1.5 //.5
#define SOLDIER_MIN_FIRING_INTERVAL 1.0 //.1
#define CANNON_MAX_FIRING_INTERVAL 5.0
#define CANNON_MIN_FIRING_INTERVAL 3.0
